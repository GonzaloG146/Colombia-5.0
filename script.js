...
// ── GLOSARIO ─────────────────────────────────────────────────
const terminos = [
  { t: "Software Libre", d: "Software que respeta la libertad del usuario para ejecutarlo, estudiarlo, modificarlo y redistribuirlo. El término hace referencia a libertad, no a precio: 'free' como en 'free speech', no como en 'free beer'." },
  { t: "Startups Unicornio", d: "Empresa emergente que alcanza una valoración de mercado igual o superior a los 1,000 millones de dólares sin cotizar en bolsa. Son extremadamente raras y representan el máximo nivel de éxito en el ecosistema emprendedor." },
  { t: "Open Source", d: "Modelo de desarrollo de software en el que el código fuente es público y puede ser libremente utilizado, modificado y distribuido por cualquier persona, fomentando la colaboración y la transparencia." },
  { t: "YOLO", d: "You Only Look Once. Framework de detección de objetos en tiempo real mediante inteligencia artificial. Destacado por Juan Fernando Ruiz Restrepo como el más recomendado para aprender y aplicar en proyectos de visión computacional." },
  { t: "Auditoría Ética", d: "Proceso de evaluación independiente que analiza si un sistema tecnológico, especialmente uno basado en IA, actúa de manera justa, transparente y responsable, sin causar daños o sesgos en sus decisiones." },
  { t: "Dockerización", d: "Proceso de empaquetar una aplicación y todas sus dependencias en un contenedor Docker, garantizando que funcione de manera consistente en cualquier entorno sin importar la infraestructura subyacente." },
  { t: "Cloud Híbrida", d: "Modelo de computación en la nube que combina infraestructura privada con servicios de nube pública, permitiendo mayor flexibilidad, control y optimización de costos según las necesidades de cada organización." },
  { t: "CamClouds7", d: "Software de videovigilancia con inteligencia artificial avanzada desarrollado por Clouds7. Integra IoT, reconocimiento facial, detección de amenazas en tiempo real y análisis de comportamiento, aplicable a seguridad, construcción, streaming y medio ambiente." },
  { t: "Merodeo Tecnológico", d: "Práctica de explorar y analizar de manera continua el entorno tecnológico para identificar tendencias emergentes, oportunidades de innovación y posibles amenazas antes de que se vuelvan mainstream." },
  { t: "Broadcasting", d: "Transmisión de contenido de audio o video desde un punto emisor hacia múltiples receptores simultáneamente. En el contexto digital abarca el streaming en vivo, la televisión por internet y la difusión masiva de contenido." },
  { t: "RS-485", d: "Estándar de comunicación serial industrial que permite la transmisión de datos a largas distancias y en entornos con ruido eléctrico. Ampliamente utilizado en sistemas de control, automatización y videovigilancia." },
  { t: "COCO", d: "Common Objects in Context. Base de datos de referencia para el entrenamiento y evaluación de modelos de visión computacional e IA, que contiene más de 330,000 imágenes con objetos etiquetados en contexto real." },
  { t: "Grammana", d: "Herramienta utilizada en el contexto de inteligencia artificial y procesamiento de datos, relacionada con la estructuración y análisis semántico de información en proyectos de IA aplicada." },
  { t: "ARIMA", d: "AutoRegressive Integrated Moving Average. Modelo estadístico para el análisis y predicción de series temporales, ampliamente aplicado en IA para pronósticos de datos secuenciales como ventas, tráfico o comportamiento." },
  { t: "Kimi", d: "Modelo de inteligencia artificial de gran escala desarrollado por Moonshot AI, conocido por su capacidad para procesar contextos muy extensos. Forma parte del ecosistema de modelos de lenguaje de código abierto." },
  { t: "Ethical Hacker", d: "Profesional de ciberseguridad autorizado para intentar vulnerar sistemas informáticos con el objetivo de identificar fallos antes de que actores maliciosos puedan explotarlos. También conocido como hacker de sombrero blanco." },
  { t: "Kickstarter", d: "Plataforma de financiamiento colectivo que permite a creadores y emprendedores recaudar fondos del público para sus proyectos. Usada por HALBERD Studios para financiar Nine Years of Shadows y Mariachi Legend." },
  { t: "Industria Saturada", d: "Mercado con alta concentración de competidores ofreciendo productos similares, lo que exige mayor creatividad e innovación para diferenciarse. Concepto central en la conferencia de Constantino Valenzuela." },
  { t: "Diseño de Niveles", d: "Disciplina del desarrollo de videojuegos que planifica, construye y equilibra los escenarios, retos y mecánicas de cada etapa para garantizar una experiencia atractiva y coherente para el jugador." },
  { t: "Motor de Videojuegos", d: "Software que provee las herramientas base (renderizado gráfico, física, sonido, animación) sobre las cuales se construyen y ejecutan los videojuegos. Ejemplos: Unity, Unreal Engine, Godot." },
  { t: "Métricas", d: "Indicadores cuantitativos para medir el rendimiento, el progreso y el impacto de un proyecto o campaña. En videojuegos y tecnología permiten tomar decisiones basadas en datos reales." },
  { t: "Unity", d: "Motor de desarrollo de videojuegos multiplataforma ampliamente utilizado por estudios independientes. Permite crear juegos en 2D y 3D para PC, consolas y móviles con un entorno accesible y gran comunidad." },
  { t: "Reglas de Diseño", d: "Conjunto de principios que guían la creación de experiencias visuales e interactivas. En videojuegos definen cómo deben comportarse los elementos para garantizar coherencia, jugabilidad y atractivo visual." },
  { t: "Omnilink7", d: "Solución de conectividad en la nube de Clouds7 que integra más de 50 cámaras IP o dispositivos IoT sin importar marca o calidad de video, sin necesidad de abrir puertos ni modificar firewalls." },
